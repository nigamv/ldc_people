...
fake_pts = [
  {:last_name => 'PartTimer', :first_name => 'Jim', :pennkey => 'jimpart', :penn_id => 12345678,
  ...
  {:last_name => 'PartTimer', :first_name => 'Jane', :pennkey => 'janepart', :penn_id => 12345876,
  ...
  {:last_name => 'Freeloader', :first_name => 'Lazy', :pennkey => 'freeload', :penn_id => 87654321,
...
fake_timesheets = [
  {:entry_id => 222333, :name => 'PARTTIMER,JIM', :penn_id => 12345678,  :entry_date => "2014-11-24 00:00:00", :hours => 1, :start_time => "2014-11-24 13:00:00", :end_time => "2014-11-24 14:00:00", :earnings_type_name => "Regular Hourly Pay",   :account_nickname => "BOLT Phase 2 Word Alignment", :pay_period_start => "2014-11-24 00:00:00", :pay_period_end => "2014-11-30 00:00:00", :hourly_rate => 12.5},
  {:entry_id => 222334, :name => 'PARTTIMER,JANE', :penn_id => 12345876,  :entry_date => "2014-11-24 00:00:00", :hours => 1, :start_time => "2014-11-24 13:00:00", :end_time => "2014-11-24 14:00:00", :earnings_type_name => "Regular Hourly Pay",   :account_nickname => "BOLT Phase 2 Word Alignment", :pay_period_start => "2014-11-24 00:00:00", :pay_period_end => "2014-11-30 00:00:00", :hourly_rate => 12.5},
  ...
  {:entry_id => 222336, :name => 'PARTTIMER,JANE', :penn_id => 12345876,  :entry_date => "2014-11-24 00:00:00", :hours => 1, :start_time => "2014-11-24 16:00:00", :end_time => "2014-11-24 17:00:00", :earnings_type_name => "Regular Hourly Pay",   :account_nickname => "DEFT TAC KBP", :pay_period_start => "2014-11-24 00:00:00", :pay_period_end => "2014-11-30 00:00:00", :hourly_rate => 12.5},
  {:entry_id => 222337, :name => 'PARTTIMER,JANE', :penn_id => 12345876,  :entry_date => "2014-11-24 00:00:00", :hours => 1, :start_time => "2014-11-24 18:00:00", :end_time => "2014-11-24 19:00:00", :earnings_type_name => "Regular Hourly Pay",   :account_nickname => "DEFT TAC KBP", :pay_period_start => "2014-11-24 00:00:00", :pay_period_end => "2014-11-30 00:00:00", :hourly_rate => 12.5},
